...
Route::group(['prefix'=>'user','middleware' => ['user']],function (){
    ...
    Route::group(['prefix'=>'jobcard'],function (){
        ...
        Route::get('download-pjBarang',  [DownloadControllerPj::class, 'downloadPjBarang']);
        Route::get('download-daftarKuantitas',  [DownloadControllerPj::class, 'downloadDaftarKuantitas']);
        ...
        Route::group(['prefix'=>'spbj'],function (){
            ...
            Route::get('download-hps/{id}',  [DownloadControllerSpbj::class, 'downloadHps']);
