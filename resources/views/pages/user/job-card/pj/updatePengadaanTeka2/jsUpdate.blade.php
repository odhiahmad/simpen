    ...
    $(document).ready(function () {
        ...
        $('.jabatan_direksi').change(function () {
            if ($(this).val() != '') {
                ...
                $(".jabatan_direksi").val($('.jabatan_direksi option:selected').data('id'));
