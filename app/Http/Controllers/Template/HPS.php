...
class HPS
{
    public function HPS($id){
        ...
        $dataSpk = PengadaanDetailSpk::where('id_pengadaan',$id)->first();
...
// Add some data, we will use some formulas here
        ...
        $sheet->mergeCells('A8:I8')
            ->setCellValue('A8', 'Nomor :'.$dataSpk->hps_nomor)->getStyle('A8')->getAlignment()->applyFromArray($arrayStyle);
        ...
        $sheet->mergeCells('D16:G16')->setCellValue('D16', ''.strval($data->tahun));
